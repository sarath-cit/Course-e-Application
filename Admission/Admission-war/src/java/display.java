...
public class display extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String q = request.getParameter("Sort");
            int i=0,n=2;
            ...
            String query = "select * from Applicant ORDER BY "+q+" DESC";  
            ResultSet rs = stmt.executeQuery(query);
            while(rs.next()){ 
                  out.println("Name: "+rs.getString("Name")+"  Caste: "+rs.getString("Community")+"  Mark: "+rs.getString("Score")+"  Gender:  "+rs.getString("Gender")+"<br><br>");
            }
            }
            catch(Exception e)
            {
